                ...
                <div className="main">
                  <div className="relative mb-5">
                    ...
                    <label className="absolute left-2 top-2">
                      ...
                      <span className="transition-all delay-[150ms] left-[23px]">e</span>
                      <span className="transition-all delay-[225ms] left-[34px]">r</span>
                      <span className="transition-all delay-[300ms] left-[42px]">n</span>
                      <span className="transition-all delay-[375ms] left-[54px]">a</span>
                      <span className="transition-all delay-[450ms] left-[64px]">m</span>
                      <span className="transition-all delay-[525ms] left-[81px]">e</span>
                  ...
                  <div className="relative mb-5">
                    ...
                    <label className="absolute left-2 top-2 w-full">
                      ...
                      <span className="transition-all delay-[150ms] left-[27px]">a</span>
                      <span className="transition-all delay-[225ms] left-[37px]">i</span>
                      <span className="transition-all delay-[300ms] left-[43px]">l</span>
                      <span className="transition-all delay-[450ms] left-[57px]">A</span>
                      <span className="transition-all delay-[525ms] left-[70px]">d</span>
                      <span className="transition-all delay-[600ms] left-[82px]">d</span>
                      <span className="transition-all delay-[675ms] left-[94px]">r</span>
                      <span className="transition-all delay-[750ms] left-[102px]">e</span>
                      <span className="transition-all delay-[825ms] left-[113px]">s</span>
                      <span className="transition-all delay-[900ms] left-[123px]">s</span>
                  ...
                  <div className="relative mb-5 md:mb-6 lg:mb-8">
                    ...
                    <label className="absolute left-2 top-2">
                      ...
                      <span className="transition-all delay-[150ms] left-[22px]">b</span>
                      <span className="transition-all delay-[225ms] left-[34px]">j</span>
                      <span className="transition-all delay-[300ms] left-[40px]">e</span>
                      <span className="transition-all delay-[375ms] left-[51px]">c</span>
                      <span className="transition-all delay-[450ms] left-[61px]">t</span>
